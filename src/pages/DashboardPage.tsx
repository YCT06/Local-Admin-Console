  ...
  const stats = [
    {
      ...
      value: "4",
      sub: "較昨日 +1",
      trend: makeTrend(40, 8),
      color: "#1D9E75",
    },
    {
      label: "CPU 平均",
      value: "32%",
      sub: "8 核心 · ofc-prod-01",
      trend: MOCK_TRENDS.cpu,
      color: "#378ADD",
    },
    {
      label: "記憶體使用",
    ...
    <div className="page">
      <div className="page-header">
        ...
        <div className="page-actions">
          ...
          >
            <Icon name="activity" size={13} /> 開啟系統狀態
          </button>
        </div>
      </div>
      ...
      <div className="notice notice-success" style={{ marginBottom: 16 }}>
        ...
        >
          <span>
            <strong>系統運作正常</strong> · 所有核心容器健康、磁碟用量
            58%、未偵測到異常告警。
          </span>
          <span style={{ fontSize: 11, color: "var(--color-success-dark)" }}>
            最後檢查 14 秒前
          </span>
        </div>
      </div>
              ...
              >
                <div
                  style={{
                    ...
                    height: 36,
                    borderRadius: 9,
                    background: "var(--color-brand-50, #E1F5EE)",
                    color: "var(--color-brand-600, #0F6E56)",
                    display: "grid",
                    placeItems: "center",
                    flexShrink: 0,
                  }}
