...
export default function PasswordPage() {
  ...
  const strengthLabel = ["", "極弱", "弱", "尚可", "良好", "強", "極強"][
    strength
  ];
  const strengthColor =
    strength <= 2 ? "#A32D2D" : strength <= 4 ? "#BA7517" : "#1D9E75";
      ...
      >
        <form className="card card-padded" onSubmit={submit}>
          ...
          <div style={{ fontSize: 12, color: "var(--color-text-secondary)" }}>
            目前登入：<strong>{user?.displayName}</strong> ·{" "}
            {user?.roles?.[0] ?? ""}
          </div>
          ...
          >
              ...
              {newPw && (
                <div style={{ marginTop: 4 }}>
                  ...
                  >
                    ...
                    <span style={{ color: strengthColor, fontWeight: 500 }}>
                      {strengthLabel}
                    </span>
                  </div>
            ...
            >
              <span
                className={"checkbox" + (show ? " checked" : "")}
                onClick={() => setShow((s) => !s)}
              >
          ...
          >
            ...
            <button
              ...
              disabled={!rules.every((r) => r.ok) || changePassword.isPending}
            >
              {changePassword.isPending ? "穩中…" : "更新密碼"}
            </button>
          </div>
        </form>
              ...
              {rules.map((r, i) => (
                <div
                  ...
                  style={{
                    ...
                    gap: 8,
                    fontSize: 12,
                    color: r.ok ? "#085041" : "var(--color-text-secondary)",
                  }}
                >
                  <span
                    style={{
